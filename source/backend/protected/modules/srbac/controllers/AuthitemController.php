...
class AuthitemController extends SBaseController {
  ...
  public function init() {
      Yii::app()->clientScript->registerScriptFile('/themes/assets/javascripts/jquery/jquery-migrate.js', CClientScript::POS_HEAD);
    parent::init();
  }
  ...
  private function _extendsSBaseController($controller) {
    ...
    if ($cont instanceof SBaseController || $cont instanceof Controller) {
      return true;
    }
    return false;
  }
