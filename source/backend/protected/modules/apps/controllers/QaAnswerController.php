...
class QaAnswerController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('QaAnswer');
	 ...
	 * @return QaAnswer the loaded model
	 ...
	 * @param QaAnswer $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='qa-answer-form')
		{
