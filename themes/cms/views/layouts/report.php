...
<head>
    ...
    <link href="<?php echo Yii::app()->theme->baseUrl; ?>/resources/assets/css/chart.css" media="all" rel="stylesheet" type="text/css"/>
    ...
    <script src="<?php echo Yii::app()->theme->baseUrl; ?>/resources/assets/javascripts/jquery.flot.categories.js" type="text/javascript"></script>
    ...
    <script src="<?php echo Yii::app()->theme->baseUrl; ?>/resources/assets/javascripts/report.js" type="text/javascript"></script>
</head>
<body>
<script type="text/javascript">demoSetBodyLayout();</script>
	...
	<section class="container">
		...
		<footer id="main-footer">
			Copyright © <?php echo date('Y'); ?> by TeamServices.vn -  All rights reserved.
